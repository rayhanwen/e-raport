			...
			<div class="tab-content" id="nav-tabContent">
				<div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
							...
							<div class="">
								<div class="row mt-3">
									...
									<tr>
										...
										<td style="width:"> : <?= $biodata['nama_guru'] ?></td>
									</tr>
									<tr>
					...
					<div align="center">
						...
						<a class="btn btn-sm btn-outline-primary" href="<?= base_url('siswa/edit_biodata/' . $biodata['nik']); ?>"><i class="fas fas-fw fa-edit"> Edit</i>
						</a>
					</div>
				</div>
			</div>
